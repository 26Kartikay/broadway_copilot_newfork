...
export const ANTHROPIC_TOOLS: any[] = [
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        query: {
          type: 'string',
          description: "The search query (e.g., 'blue dress', 'denim jacket')",
        },
        category: {
          type: 'string',
          description:
  ...
  },
  {
    ...
    description:
      'Recall what you know about this user - their color season, style preferences, past interactions. Call at the start of sessions or when you need to personalize a response.',
    input_schema: {
      type: 'object',
      properties: {
        userId: { type: 'string', description: 'The user ID' },
        context: {
          type: 'string',
          description: 'Optional context to search for specific memories',
        },
      },
      required: ['userId'],
    },
    ...
    input_schema: {
      ...
      properties: {
        ...
        existingPieces: {
          type: 'array',
          items: { type: 'string' },
          description: 'Items user already has',
        },
      },
