...
CREATE TABLE "UserProfile" (
    ...
    "budgetRange" TEXT,
    "behavioralTraits" TEXT[] DEFAULT ARRAY[]::TEXT[],
...
-- CreateIndex
CREATE INDEX "Product_gender_ageGroup_idx" ON "Product"("gender", "ageGroup");

-- CreateIndex
CREATE INDEX "Product_colorPalette_idx" ON "Product"("colorPalette");

-- CreateIndex
CREATE INDEX "Product_allTags_idx" ON "Product"("allTags");
