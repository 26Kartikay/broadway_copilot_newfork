...
-- CreateEnum
CREATE TYPE "Severity" AS ENUM ('DEBUG', 'INFO', 'WARNING', 'ERROR', 'CRITICAL', 'DEFAULT');
...
CREATE TABLE "Product" (
    ...
    "generalTag" TEXT NOT NULL,
    "style" TEXT,
    "fit" TEXT,
    "colors" TEXT[],
    "patterns" TEXT,
    "occasions" TEXT[],
    "componentTags" JSONB NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_handleId_key" ON "Product"("handleId");

-- CreateIndex
CREATE INDEX "Product_category_idx" ON "Product"("category");

-- CreateIndex
CREATE INDEX "Product_generalTag_idx" ON "Product"("generalTag");
...
-- CreateIndex
CREATE INDEX "Product_patterns_idx" ON "Product"("patterns");
...
-- CreateIndex
CREATE INDEX "ServiceLog_createdAt_idx" ON "ServiceLog"("createdAt" DESC);

-- CreateIndex
CREATE INDEX "ServiceLog_userId_createdAt_idx" ON "ServiceLog"("userId", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "ServiceLog_severity_createdAt_idx" ON "ServiceLog"("severity", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "ServiceLog_service_createdAt_idx" ON "ServiceLog"("service", "createdAt" DESC);

-- CreateIndex
CREATE INDEX "ServiceLog_appUserId_idx" ON "ServiceLog"("appUserId");

-- CreateIndex
CREATE INDEX "ServiceLog_whatsappId_idx" ON "ServiceLog"("whatsappId");
